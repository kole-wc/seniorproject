...
namespace pms
{
    public partial class FormExportReportBS : Form
    {
        DataManager m1 = new DataManager("localhost", "seniorproject", "root", "");
        public FormExportReportBS()
        {
            InitializeComponent();
        }//ef

        private void FormExportReportBS_Load(object sender, EventArgs e)
        {
        ...
        private void FormExportReportBS_FormClosed(object sender, FormClosedEventArgs e)
        {
            string sql = "TRUNCATE TABLE selling";
            m1.ExecuteNonQuery(sql);
            this.DialogResult = DialogResult.OK;
